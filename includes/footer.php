...
?>
<footer class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-gray-200 pt-10 pb-6 text-sm text-gray-500 mt-8">
    ...
    <div class="mt-8 pt-4 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-gray-400">
