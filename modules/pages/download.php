<?php
// modules/pages/download.php - PDF Download Handler
...
try {
    $stmt = $db->prepare("
        INSERT INTO article_downloads (manuscript_id, ip_address, downloaded_at) 
        VALUES (?, ?, NOW())
    ");
...
header('Content-Disposition: attachment; filename="' . sanitizeFilename($article['title']) . '.pdf"');
